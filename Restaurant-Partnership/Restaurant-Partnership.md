...
|New restaurants onboarded|5|
|Restaurants churned (left platform)|5|
|Net growth|80|
|Churn rate (%)|10|
...
|Metric|Value|
|-|-|
|Average order acceptance rate (%)|100%|
|Average food preparation time|25 min|
|Average menu size (items listed)|10|
|Restaurants using self-serve dashboard (%)|20%|
...
|Total grievances / complaints raised|10|
|Top grievance category|Delivery Time Dealy|
|Average grievance resolution time|2-3 days|

### Cuisine \& Category Breakdown

|Cuisine / Category|Active Partners|% of Total|Order Share (%)|
|-|-|-|-|
|Indian|Saravana Catering|45|35|
|Mexian|QWERTY|10|20|
|Chinese|POIU|20|15|
|Italian|MNB|20|30|
|Catering Service|KCTR|5|10|

### Partnership Tiers

|Tier|Count|Benefits|
|-|-|-|
|Free (basic listing)|25|atleast|
|Commission-based|10|medium|
|Premium (featured)|5|high|

### Key Highlights

*What went well this fiscal year? New partnerships, retention wins, platform improvements?*

*New Partnership, and New cuisines, new categoroies, and zero branching*
...
Much load to handle, less man power, Delivery Time finds difficult
===========================
